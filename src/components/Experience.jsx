...
export default function Experience() {
  return <section className="section experience-section" id="experience"><div className="container">
    <div className="section-heading"><div><p className="kicker">WHERE I’VE CONTRIBUTED</p><h2>Professional<br /><em>experience.</em></h2></div><span className="section-number">02 — EXPERIENCE</span></div>
    <div className="experience-list">{experiences.map((job, index) => <article className="experience-card" key={job.role}>
