...
export default function Projects() {
  return <section className="section projects-section" id="projects"><div className="container">
    <div className="section-heading"><div><p className="kicker">SELECTED WORK</p><h2>Work that makes<br /><em>an impact.</em></h2></div><span className="section-number">04 — PROJECTS</span></div>
